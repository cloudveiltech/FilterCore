...
namespace CitadelCore.Net
{
    //TODO: If localization resources are not found, logging does not work. Issue #5126.
    [EventSource(Name = "CitadelCore-Net-Http", LocalizationResources = "FxResources.System.Net.Http.SR")]
    internal sealed partial class NetEventSource : EventSource
    {
        ...
        [NonEvent]
        public static void ClientSendCompleted(FilterHttpClient httpClient, HttpResponseMessage response, HttpRequestMessage request)
        {
            if (IsEnabled)
            {
