        ...
        public X509CertificateCollection ClientCertificates
        {
            get
            {
                ...
                else
                {
                    ...
                    {
                        throw new InvalidOperationException(System.SR.Format(SR.net_http_invalid_enable_first, nameof(ClientCertificateOptions), nameof(ClientCertificateOption.Manual)));
                    }
